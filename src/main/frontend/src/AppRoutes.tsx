...
import { ManageAvailabilityPageWrapper } from './components/wrappers/ManageAvailabilityPageWrapper';
    ...
    <Router>
        ...
        <Box sx={mainContentBox}>
            <Routes>
                ...
                <Route
                    path="/:entityType/:entityId/availabilities"
                    element={<ManageAvailabilityPageWrapper />}
                />
