...
public class DataInitializer {
    ...
    CommandLineRunner initDatabase(StudentRepository studentRepository,
                                   StudentClassRepository classRepository, TherapistRepository therapistRepository, RoomRepository roomRepository, ScheduleSlotRepository scheduleSlotRepository) {
        return args -> {
